...
const Navbar = () => {
  ...
  // Ajout du bouton admin invisible
  const adminButton = (
    <Link to="/login" className="fixed bottom-1 right-1 z-10" aria-label="Administration">
      <Button 
        variant="invisible" 
        size="xs" 
        className="opacity-5 hover:opacity-20 w-4 h-4"
      >
        ∙
      </Button>
    </Link>
