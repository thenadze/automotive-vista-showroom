    ...
    <section className="py-16 bg-stone-50">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/5 relative overflow-hidden rounded-lg shadow-lg">
            <img 
              src="/lovable-uploads/3d4e4462-0a40-4bbe-aae2-239b4eb762dd.png" 
              alt="Véhicules en exposition" 
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-6">
              <h3 className="text-2xl font-bold text-white mb-2">Notre sélection premium</h3>
              <p className="text-white/90 mb-4">Découvrez notre gamme de véhicules soigneusement sélectionnés pour répondre à toutes vos attentes.</p>
              <Button 
                asChild 
                className="bg-white text-stone-800 hover:bg-stone-100 w-fit"
              >
                <Link to="/cars">
