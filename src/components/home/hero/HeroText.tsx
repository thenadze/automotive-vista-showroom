...
const HeroText: React.FC<HeroTextProps> = ({ createMarkup }) => {
  ...
  const fullText = "Fondée en 2023 à Bezons, Automotive propose une sélection de véhicules soigneusement choisis, adaptés à tous les styles de vie et à tous les usages. Dès les premiers échanges, l'entreprise accompagne chaque client avec attention : conseils personnalisés, transparence, et préparation rigoureuse des véhicules avant la vente. Automotive incarne une nouvelle vision de la vente automobile, fondée sur la proximité, la confiance et l'exigence de qualité. <span class='block mt-2 text-sm opacity-80'><a href='#contact' class='text-orange-500 hover:underline'>Ouvert 7j/7 de 10h à 19h sans rendez-vous <Clock className='inline-block w-3 h-3 mb-0.5' /></a></span>";
  
  // Version encore plus courte pour mobile
  const mobileShortenedText = "Fondée en 2023 à Bezons, Automotive propose une sélection de véhicules soigneusement choisis. <span class='block mt-2 text-xs opacity-80'><a href='#contact' class='text-orange-500 hover:underline'>Ouvert 7j/7 de 10h à 19h sans rendez-vous <Clock className='inline-block w-3 h-3 mb-0.5' /></a></span>";
  
  // Version pour desktop
  const desktopShortenedText = "Fondée en 2023 à Bezons, Automotive propose une sélection de véhicules soigneusement choisis, adaptés à tous les styles de vie et à tous les usages. Dès les premiers échanges, l'entreprise accompagne chaque client avec attention : conseils personnalisés, transparence, et préparation rigoureuse des véhicules avant la vente. <span class='block mt-2 text-sm opacity-80'><a href='#contact' class='text-orange-500 hover:underline'>Ouvert 7j/7 de 10h à 19h sans rendez-vous <Clock className='inline-block w-3 h-3 mb-0.5' /></a></span>";
